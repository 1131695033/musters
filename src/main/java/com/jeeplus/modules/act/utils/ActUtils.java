...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_PRC_ADJ = new String[]{"p_prc_adj", "p_prc_adj"}; //水价调价申请
	public static final String[] PD_PLAN = new String[]{"plan", "plan"};
	public static final String[] PD_RS_APP = new String[]{"rsApp", "rsApp"};
	public static final String[] PD_PENALTY_DEFER = new String[]{"a_penalty_defer", "a_penalty_defer"}; //违约金减免申请
	public static final String[] PD_REFUND = new String[]{"a_refund", "a_refund"};
	public static final String[] PD_COMP_SUPPLY = new String[]{"a_comp_supply", "a_comp_supply"};
