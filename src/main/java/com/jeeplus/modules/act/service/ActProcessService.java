...
public class ActProcessService extends BaseService {
	 ...
	 * 运行中的流程
	 */
	public Page<HashMap<String,String>> runningList(Page<ProcessInstance> page, String procInsId, String procDefKey, String appNo) {
	    ...
	    if (StringUtils.isNotBlank(appNo)){
		    processInstanceQuery.processInstanceBusinessKey(appNo);
	    }
		...
		for (ProcessInstance p : runningList) {
			...
			map.put("appNo",(String)runtimeService.getVariable(p.getId(),"appNo").toString());
			map.put("applyUserId",(String)runtimeService.getVariable(p.getId(),"applyUserId").toString());
	 ...
	 * 已结束的流程
	 */
	public Page<HistoricProcessInstance> historyList(Page<HistoricProcessInstance> page, String procInsId, String procDefKey,String appNo) {
	    ...
	    if (StringUtils.isNotBlank(appNo)){
	    	query.processInstanceBusinessKey(appNo);
	    }
