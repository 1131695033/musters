		  ...
		  //请求方法
   			...
   			,{
		        ...
		        formatter: function operateFormatter(value, row, index) {
		        	var arra = new Array();
		        	arra.push( '<a href="${ctx}/act/task/form?taskId='+row['task.id']+'&taskName='+encodeURI(row['task.name'])+'&taskDefKey='+row['task.taskDefinitionKey']+'&procInsId='+row['task.processInstanceId']+'&procDefId='+row['task.processDefinitionId']+'&status='+row.status+'">'+value+'</a>');
		        	return arra.join("");
	            }
