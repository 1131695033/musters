...
<head>
	...
	<%@include file="actTaskHistoricList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">已办任务</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body">
		<div class="accordion-inner">
			...
			<label class="label-item single-overflow pull-left" title="申请编号">申请编号：</label>
				<form:input path="appNo" htmlEscape="false" maxlength="16"  class=" form-control"/>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				 <div class="form-group">
					<label class="label-item single-overflow pull-left" title="创建时间：">&nbsp;完成时间：</label>
					<div class="col-xs-12">
