...
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="leaveForm" class="form form-horizontal well clearfix">
	...
	<div id="toolbar">
			<shiro:hasPermission name="test:one:leaveForm:add">
				<a id="add" class="btn btn-primary" href="${ctx}/test/one/leaveForm/form" title="请假表单"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
	...
	<!-- 表格 -->
	<table id="leaveFormTable"   data-toolbar="#toolbar"></table>
