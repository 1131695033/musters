...
<head>
	...
	<%@include file="testDataMainFormList.js" %>
</head>
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="testDataMainForm" class="form form-horizontal well clearfix">
	...
	<div id="toolbar">
			<shiro:hasPermission name="test:onetomanyform:testDataMainForm:add">
				<a id="add" class="btn btn-primary" href="${ctx}/test/onetomanyform/testDataMainForm/form" title="票务代理"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="test:onetomanyform:testDataMainForm:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="test:onetomanyform:testDataMainForm:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="test:onetomanyform:testDataMainForm:import">
