...
<head>
	...
	<%@include file="testDataMainDialogList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">票务代理列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="testDataMainDialog" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="test:onetomanydialog:testDataMainDialog:add">
			...
			<shiro:hasPermission name="test:onetomanydialog:testDataMainDialog:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="test:onetomanydialog:testDataMainDialog:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/test/onetomanydialog/testDataMainDialog/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="testDataMainDialogTable"   data-toolbar="#toolbar"></table>
