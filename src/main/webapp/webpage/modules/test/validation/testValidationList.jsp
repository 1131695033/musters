...
<body>
	...
	<div id="toolbar">
			<shiro:hasPermission name="test:validation:testValidation:add">
				<a id="add" class="btn btn-primary" href="${ctx}/test/validation/testValidation/form" title="测试校验"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			...
			<shiro:hasPermission name="test:validation:testValidation:import">
				...
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/test/validation/testValidation/import" method="post" enctype="multipart/form-data"
