...
<body>
	...
	<div id="toolbar">
			<shiro:hasPermission name="test:manytomany:studentCourse:add">
				<a id="add" class="btn btn-primary" href="${ctx}/test/manytomany/studentCourse/form" title="学生课程记录"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			...
			<shiro:hasPermission name="test:manytomany:studentCourse:import">
				...
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/test/manytomany/studentCourse/import" method="post" enctype="multipart/form-data"
