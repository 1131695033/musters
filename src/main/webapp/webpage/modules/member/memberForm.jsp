		...
		$(document).ready(function() {
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jp.post("${ctx}/member/member/save",$('#inputForm').serialize(),function(data){
						if(data.success){
		...
		<table class="table table-bordered">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="points" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">worker_id：</label></td>
					<td class="width-35">
						<form:input path="workerId" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">seller_id：</label></td>
					<td class="width-35">
						<form:input path="sellerId" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
		 	</tbody>
		</table>
