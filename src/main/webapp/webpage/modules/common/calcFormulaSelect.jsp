			...
			//初始化表格
			  $('#table').bootstrapTable({
				  ...
				  //请求方法
	                ...
	                url: "${ctx}/calcformula/calcFormula/data",
...
<div  class="col-sm-12 col-md-12 animated fadeInRight">
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="calcFormula" class="form form-horizontal well clearfix">
				<div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="公式名称：">公式名称：</label>
				<form:input path="formulaName" htmlEscape="false" maxlength="256"  class=" form-control"/>
			</div>
