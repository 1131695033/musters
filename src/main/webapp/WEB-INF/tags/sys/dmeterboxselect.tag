...
<%@ attribute name="consId" type="java.lang.String" required="false" description="用户id"%>
...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		// 正常打开	
		jp.openPubSelectDialog(${isMultiSelected? true:false},"/dmeterbox/dMeterBox/dMeterBoxSelect?consId=${consId}","表箱",function(ids, names){
