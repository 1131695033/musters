...
<%@ attribute name="meterBore" type="java.lang.String" required="true" description="口径"%>
...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		// 正常打开	
		jp.openGmInfoSelectDialog(${isMultiSelected? true:false},"${meterBore}",function(ids, names){
